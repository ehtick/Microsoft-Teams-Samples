...
| 3  | Channel and group tabs                     | Sample app showing custom group and channel Tab with ASP.NET Core.                                                                                                                                                              | Basic        | [MVC][group-channel-tab#cs#mvc], [Razor][group-channel-tab#cs#razor] | [Yeoman Generator](https://docs.microsoft.com/en-us/microsoftteams/platform/get-started/get-started-yeoman) |                                             | [View](/samples/TeamsJS/tab-channel-group/mvc-csharp/demo-manifest/tab-channel-group.zip) |
| 4  | Channel and group tab quick-start          | Sample channel and group tab hello world app.                                                                                                                                                                                   | Basic        | [View][group-tab-quickstart#csharp]     | [View][group-tab-quickstart#ts] ![toolkit-icon](assets/toolkit-icon.png) | [View][group-tab-quickstart#js] ![toolkit-icon](assets/toolkit-icon.png) | [View](/samples/TeamsJS/tab-channel-group-quickstart/js/demo-manifest/tab-channel-group-quickstart.zip) |
| 5  | SPFx Tab                                   | Sample app showing Microsoft Teams tabs using SharePoint Framework.                                                                                                                                                             | Basic        |                                         | [View][group-channel-tab#ts#spfx]           |                                             |                                                                    |
| 6  | Tab people picker                          | This is a tab app that shows the feature of the client SDK people picker.                                                                                                                                                         | Basic        | [View][tab-people-picker#csharp]        |                                             | [View][tab-people-picker#nodejs] ![toolkit-icon](assets/toolkit-icon.png) | [View](/samples/TeamsJS/tab-people-picker/csharp/demo-manifest/Tab-People-Picker.zip) |
...
| 9  | Personal tab with SSO quick-start          | Sample personal tab with SSO hello world app.                                                                                                                                                                                   | Intermediate | [View][personal-tab-sso-quickstart#csharp] | [View][personal-tab-sso-quickstart#ts] ![toolkit-icon](assets/toolkit-icon.png) | [View][personal-tab-sso-quickstart#js] ![toolkit-icon](assets/toolkit-icon.png) |[View](/samples/TeamsJS/tab-personal-sso-quickstart/csharp_dotnetcore/demo-manifest/tab-personal-sso-quickstart.zip) |                                                                    |
| 10 | Channel and group tab with SSO quick-start | Sample channel and group tab with SSO hello world app.                                                                                                                                                                          | Intermediate | [View][group-tab-sso-quickstart#csharp] | [View][group-tab-sso-quickstart#ts] ![toolkit-icon](assets/toolkit-icon.png) | [View][group-tab-sso-quickstart#js] ![toolkit-icon](assets/toolkit-icon.png) |[View](/samples/TeamsJS/tab-channel-group-sso-quickstart/csharp_dotnetcore/demo-manifest/tab-channel-group-sso-quickstart.zip) |                                                                  |
...
| 13 | Device permissions                         | Microsoft Teams tab sample app for demonstrating device permissions.                                                                                                                                                              | Intermediate |                                         | [View][tab-device-permissions#js] ![toolkit-icon](assets/toolkit-icon.png) |                                             | [View](/samples/TeamsJS/tab-device-permissions/nodejs/demo-manifest/tab-device-permissions.zip) |
...
| 3  | Graph API Channel Life Cycle                         | This sample illustrates how you can use [Graph API Channel Life Cycle](https://docs.microsoft.com/en-us/graph/api/resources/channel?view=graph-rest-beta) to call Graph APIs. | Intermediate | [View][graph#lifecycle#cs]       | [View][graph#lifecycle#js] ![toolkit-icon](assets/toolkit-icon.png) |[View](samples/TeamsJS/graph-channel-lifecycle/csharp/demo-manifest/graph-channel-lifecycle.zip)                                                          |
| 4  | Graph API Teams App Installation Life Cycle          | This sample illustrates how you can use [Teams App Installation Life Cycle](https://docs.microsoft.com/en-us/graph/api/resources/teamsappinstallation?view=graph-rest-1.0) by calling Microsoft Graph APIs. | Intermediate | [View][graph#instllationlifecycle#cs] | [View][graph#instllationlifecycle#js] ![toolkit-icon](assets/toolkit-icon.png) | [View](samples/TeamsJS/graph-app-installation-lifecycle/csharp/demo-manifest/graph-app-installation-lifecycle.zip) |
...
| 13 | Resource Specific Consent (RSC)                      | This sample illustrates how you can use [Resource Specific Consent (RSC)](https://docs.microsoft.com/en-us/microsoftteams/platform/graph-api/rsc/resource-specific-consent) to call Graph APIs. | Advanced     | [View][graph#rsc#cs]              | [View][graph#rsc#js] ![toolkit-icon](assets/toolkit-icon.png) | [View](samples/TeamsJS/graph-rsc/csharp/demo-manifest/graph-rsc.zip)     |
...
| 17 | Graph chat migration bot | This sample demonstrates how to migrate external chats to teams using microsoft graph API's. | Intermediate | [View][graph-chat-migration#cs] | [View][graph-chat-migration#js] ![toolkit-icon](assets/toolkit-icon.png) | | | |
...
| 6  | Meeting Recruitment App                | Sample app showing meeting app experience for interview scenario.                                                 | Intermediate | [View][meeting-recruitment-app#cs]            | [View][meeting-recruitment-app#js] ![toolkit-icon](assets/toolkit-icon.png)          | [View](/samples/TeamsJS/meeting-recruitment-app/csharp/demo-manifest/Meeting-Recruitment-App.zip)     |
...
| 10 | Tab request approval                          | Enables users to raise requests for managers to approve or reject, with notifications and task module redirections.   | Intermediate | [View][tab-request-approval#csharp]         | [View][tab-request-approval#nodejs] ![toolkit-icon](assets/toolkit-icon.png)            | [View](/samples/TeamsJS/tab-request-approval/csharp/demo-manifest/Tab-Request-Approval.zip) |
...
[personal-tab-quickstart#ts]:samples/TeamsJS/tab-personal-quickstart/ts
[personal-tab-quickstart#js]:samples/TeamsJS/tab-personal-quickstart/js
[personal-tab-sso-quickstart#ts]:samples/TeamsJS/tab-personal-sso-quickstart/ts
[personal-tab-sso-quickstart#csharp]:samples/TeamsJS/tab-personal-sso-quickstart/csharp_dotnetcore
[personal-tab-sso-quickstart#js]:samples/TeamsJS/tab-personal-sso-quickstart/js
[group-tab-quickstart#csharp]:samples/TeamsJS/tab-channel-group-quickstart/csharp
[group-tab-quickstart#ts]:samples/TeamsJS/tab-channel-group-quickstart/ts
[group-tab-quickstart#js]:samples/TeamsJS/tab-channel-group-quickstart/js
[group-tab-sso-quickstart#ts]:samples/TeamsJS/tab-channel-group-sso-quickstart/ts
[group-tab-sso-quickstart#js]:samples/TeamsJS/tab-channel-group-sso-quickstart/js
[group-tab-sso-quickstart#csharp]:samples/TeamsJS/tab-channel-group-sso-quickstart/csharp_dotnetcore
...
[tab-graph-toolkit#js]:samples/TeamsJS/tab-graph-toolkit/nodejs
[tab-graph-toolkit#csharp]:samples/TeamsJS/tab-graph-toolkit/csharp
[tab-device-permissions#js]:samples/TeamsJS/tab-device-permissions/nodejs
...
[tab-app-navigation#csharp]:samples/TeamsJS/tab-app-navigation/csharp
...
[tab-product-inspection#csharp]:samples/TeamsJS/tab-product-inspection/csharp
[tab-staggered-permission#csharp]:samples/tab-staggered-permission/csharp
[tab-people-picker#csharp]:samples/TeamsJS/tab-people-picker/csharp
[tab-channel-group=config-csharp]:samples/tab-channel-group-config-page-auth/csharp
[tab-channel-context#nodejs]:samples/TeamsJS/tab-channel-context/nodejs
[tab-app-monetization#nodejs]:samples/TeamsJS/tab-app-monetization/nodejs
[app-cache-meetings#nodejs]:samples/TeamsJS/app-cache-meetings/nodejs
[tab-request-approval#nodejs]:samples/TeamsJS/tab-request-approval/nodejs
[bot-request-approval#nodejs]:samples/bot-request-approval/nodejs
[tab-navbar-menu#ts]:samples/TeamsJS/tab-navbar-menu/ts
[tab-multi-hub#ts]:samples/TeamsJS/tab-multi-hub/ts
[tab-ui-templates#ts]:samples/TeamsJS/tab-ui-templates/ts
[tab-external-auth#csharp]:samples/TeamsJS/tab-external-auth/csharp
...
[group-channel-tab#ts#spfx]:samples/TeamsJS/tab-channel-group/spfx
[tab-channel-group#js]:samples/TeamsJS/tab-channel-group/nodejs

[connector#cs]:samples/connector-todo-notification/csharp
[incoming-webhook#cs]:samples/TeamsJS/incoming-webhook/csharp
...
[connector#ts]:samples/TeamsJS/connector-github-notification/nodejs
...
[graph-activity-feed-broadcast#csharp]:samples/TeamsJS/graph-activity-feed-broadcast/csharp


[app-task-module#ts]:samples/TeamsJS/app-task-module/nodejs
[app-task-module#cs]:samples/TeamsJS/app-task-module/csharp
...
[user-scope-web-application#js]:samples/TeamsJS/user-scope-web-application/nodejs
...
[productinspection#nodejs]:samples/TeamsJS/tab-product-inspection/nodejs
...
[tab-request-approval#csharp]:samples/TeamsJS/tab-request-approval/csharp
...
[meetings-live-code-interview#csharp]:samples/TeamsJS/meetings-live-code-interview/csharp
[meetings-live-code-interview#nodejs]:samples/TeamsJS/meetings-live-code-interview/nodejs
...
[meeting-recruitment-app#cs]:samples/TeamsJS/meeting-recruitment-app/csharp
...
[incoming-webhook#nodejs]:samples/TeamsJS/incoming-webhook/nodejs
[meetingtabs#csharp]:samples/TeamsJS/meeting-tabs/csharp
[meetingtabs#nodejs]:samples/TeamsJS/meeting-tabs/nodejs
...
[graph#rsc#cs]:samples/TeamsJS/graph-rsc/csharp
[graph#rsc#js]:samples/TeamsJS/graph-rsc/nodeJs
[graph#lifecycle#cs]:samples/TeamsJS/graph-channel-lifecycle/csharp
[graph#lifecycle#js]:samples/TeamsJS/graph-channel-lifecycle/nodejs
[graph#instllationlifecycle#cs]:samples/TeamsJS/graph-app-installation-lifecycle/csharp
[graph#instllationlifecycle#js]:samples/TeamsJS/graph-app-installation-lifecycle/nodejs
...
[graph#membershipchangenotification#cs]:samples/TeamsJS/graph-membership-change-notification/csharp
[graph#membershipchangenotification#js]:samples/TeamsJS/graph-membership-change-notification/nodejs
[graph#graphproactiveinstallation#cs]:samples/graph-proactive-installation/csharp
[graph#graphproactiveinstallation#js]:samples/graph-proactive-installation/nodejs
[graph-activity-feed#cs]:samples/TeamsJS/graph-activity-feed/csharp
[graph-activity-feed#js]:samples/TeamsJS/graph-activity-feed/nodejs
...
[graph-activity-feed-broadcast#js]:samples/TeamsJS/graph-activity-feed-broadcast/nodejs
[graph-pinned-message#cs]:samples/TeamsJS/graph-pinned-messages/csharp
[graph-pinned-message#js]:samples/TeamsJS/graph-pinned-messages/nodejs
[graph-bulk-meetings#cs]:samples/TeamsJS/graph-bulk-meetings/csharp
[graph-bulk-meetings#js]:samples/TeamsJS/graph-bulk-meetings/nodejs
[graph-file-fetch#cs]:samples/graph-file-fetch/csharp
[graph-file-fetch#js]:samples/graph-file-fetch/nodejs
[change-notifications-team/channel#cs]:samples/TeamsJS/graph-change-notification-team-channel/csharp
[change-notifications-team/channel#js]:samples/TeamsJS/graph-change-notification-team-channel/nodejs
[graph-teams-tag#cs]:samples/TeamsJS/graph-teams-tag/csharp
[graph-teams-tag#js]:samples/TeamsJS/graph-teams-tag/nodejs
[graph-rsc-helper#js]:samples/TeamsJS/graph-rsc-helper/nodeJs
...
[bot-conversation-sso-quickstart#js]:samples/bot-conversation-sso-quickstart/js
[graph-chat-migration#js]:samples/graph-chat-migration/nodejs
