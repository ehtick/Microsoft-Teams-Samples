---
page_type: sample
description: This sample illustrates the tab navigation feature in a Microsoft Teams application, enabling smooth transitions between different tabs. Designed for use with python, it highlights how users can effectively navigate within the app for an enhanced experience.
products:
- office-teams
- office
- office-365
...
extensions:
 contentType: samples
 createdDate: "03-04-2025 13:38:25"
urlFragment: officedev-microsoft-teams-samples-tab-app-navigation-python
---
...
5) In a terminal, go to `samples\tab-app-navigation`
...
9)  **Update Placeholder For External App ID**
- Get the external app id from teams admin portal (https://admin.teams.microsoft.com/policies/manage-apps)
- Replace placeholder `<<External-App-Id>>` with your     actual external app id which you can get from teams admin portal.
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/TeamsJS/tab-app-navigation-python" />